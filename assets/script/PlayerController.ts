import { _decorator, Component, Node, animation, RigidBody, Vec3, tween, Quat, ITriggerEvent, Collider, ICollisionEvent, BoxCollider, resources, Tween, instantiate } from 'cc';
